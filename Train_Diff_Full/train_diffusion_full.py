...
if __name__ == '__main__':
    ...
    # Load your data here (assuming it's loaded into 'data' variable)
    data = np.load("/home/junze/.jupyter/Data transfer and loading/dataset_1.csv.npy") # Replace with your actual data
    ...
    # Visualize and save generated trajectories plot
