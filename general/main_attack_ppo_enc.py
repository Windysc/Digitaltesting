...
Same training / evaluation loop as main_attack_ppo_scen.py (the loop of the 2024 reference
script main_attack_ppo.py, which left the repository on 2026-09-24);
